...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1282: x0 => x0.play(),
      _1283: x0 => x0.pause(),
      _1287: (x0,x1) => x0.removeAttribute(x1),
      _1289: (x0,x1) => x0.start(x1),
      _1290: (x0,x1) => x0.end(x1),
      _1291: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1292: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1293: (x0,x1) => x0.createElement(x1),
      _1299: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1319: Date.now,
      ...
      _1544: () => new AbortController(),
      _1545: x0 => x0.abort(),
      _1546: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1547: (x0,x1) => globalThis.fetch(x0,x1),
      _1548: (x0,x1) => x0.get(x1),
      _1549: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1549(f,arguments.length,x0,x1,x2) }),
      _1550: (x0,x1) => x0.forEach(x1),
      _1551: x0 => x0.getReader(),
      _1552: x0 => x0.cancel(),
      _1553: x0 => x0.read(),
      ...
      _1626: Function.prototype.call.bind(BigInt.prototype.toString),
      _1627: Function.prototype.call.bind(Number.prototype.toString),
      _1628: (d, digits) => d.toFixed(digits),
      _1815: x0 => x0.style,
      _2387: x0 => x0.videoWidth,
      _2388: x0 => x0.videoHeight,
      _2392: (x0,x1) => { x0.playsInline = x1 },
      _2418: x0 => x0.error,
      _2420: (x0,x1) => { x0.src = x1 },
      _2429: x0 => x0.buffered,
      _2432: x0 => x0.currentTime,
      _2433: (x0,x1) => { x0.currentTime = x1 },
      _2434: x0 => x0.duration,
      _2439: (x0,x1) => { x0.playbackRate = x1 },
      _2446: (x0,x1) => { x0.autoplay = x1 },
      _2448: (x0,x1) => { x0.loop = x1 },
      _2450: (x0,x1) => { x0.controls = x1 },
      _2452: (x0,x1) => { x0.volume = x1 },
      _2454: (x0,x1) => { x0.muted = x1 },
      _2469: x0 => x0.code,
      _2470: x0 => x0.message,
      _2543: x0 => x0.length,
      _3516: () => globalThis.window,
      _3578: x0 => x0.navigator,
      _3967: x0 => x0.userAgent,
      _6122: x0 => x0.signal,
      _6196: () => globalThis.document,
      _6612: (x0,x1) => { x0.id = x1 },
      _7958: x0 => x0.value,
      _7960: x0 => x0.done,
      _8662: x0 => x0.url,
      _8664: x0 => x0.status,
      _8666: x0 => x0.statusText,
      _8667: x0 => x0.headers,
      _8668: x0 => x0.body,
      _10796: (x0,x1) => { x0.border = x1 },
      _11238: (x0,x1) => { x0.height = x1 },
      _11928: (x0,x1) => { x0.width = x1 },
      _12296: x0 => x0.name,
      _12297: x0 => x0.message,
